...
document.getElementById('logo').onclick = () => {
  location.href = 'http://127.0.0.1:5500/Project/html/mainPage.html';
}
...
// 공지사항
function toNotices() {
  location.href = 'http://127.0.0.1:5500/Project/html/notices.html';
}
...
if (current == null) {
  ...
  lis[1].onclick = () => {
    location.href = 'http://127.0.0.1:5500/Project/html/login.html';
  };
} else {
  // 관리자 계정
  ...
  logout.onclick = () => {
    ...
    if (location.href.includes('notices')) {
      location.reload();
    } else location.href = 'http://127.0.0.1:5500/Project/html/mainPage.html';
  };
}